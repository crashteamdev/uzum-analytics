        ...
        private const val GET_PRODUCT_HISTORY_SQL = """
            ...
            FROM (
                 SELECT date,
                        ...
                        sku_id,
                        title,
                        multiIf(available_amount_max > prev_last_available_amount, 0,
                                inner_available_amount_diff == 0 AND prev_last_available_amount > available_amount_max, prev_last_available_amount - available_amount_max,
                                inner_available_amount_diff) AS available_amount_diff,
                        available_amount_max - available_amount_min       AS inner_available_amount_diff,
